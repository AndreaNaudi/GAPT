...
namespace GAPT.Models
{
    ...
    public partial class GaptDbContext : DbContext
    {
        ...
        public virtual DbSet<Thread_Comment> Thread_Comment { get; set; }
        public virtual DbSet<Type_General> Type_General { get; set; }
