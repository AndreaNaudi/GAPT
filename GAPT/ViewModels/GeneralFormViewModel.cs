...
namespace GAPT.ViewModels
{
    public class GeneralFormViewModel
    {
        ...
        public IEnumerable<string> SelectedProposers { get; set; }
        public IEnumerable<SelectListItem> Proposers { get; set; }

        public IEnumerable<string> SelectedShared { get; set; }
        public IEnumerable<SelectListItem> Shared { get; set; }
